...
struct Request {
     ...
     * @param inputName
     * @param inputCylinderNumber
     * @param inputLength
     */
    Request(string inputName, int inputCylinderNumber, int inputLength)
        :name(inputName),cylinderNumber(inputCylinderNumber), length(inputLength){
    }
        ...
        while(getline(myfile, line)){
            if(line!="Initial Cylinder #" && doThis==false){
                if(counter%2==0)
                    ...
                    geek>>number;
                    returnList.push_back(Request(name, number, 0));
                }
            }
            else if (doThis==true) {
                stringstream geek(line);
 ...
 */
vector<Request> first_come_first_serverd(int starting_cylinder, vector<Request> requests){
    int sum_of_cylinders = 0, temp;
    vector<Request> ans;
    Request t = Request();
    t.cylinderNumber = starting_cylinder;
    ans.push_back(t);
    for(size_t i = 0; i<requests.size(); i++){
        temp = abs(starting_cylinder - requests[i].cylinderNumber);
        Request in =  Request(requests[i].name, requests[i].cylinderNumber, temp);
        ans.push_back(in);
...
vector<Request> shortest_seek_first(int starting_cylinder, vector<Request> requests){
    ...
    while(!requests.empty()){
        ...
        Request in =  Request(requests[static_cast<size_t>(index)].name, requests[static_cast<size_t>(index)].cylinderNumber, smallest);
        ans.push_back(in);
...
vector<Request> elevator_moving_upward(int starting_cylinder, vector<Request> requests){
...
vector<Request> createTestCase(int starting_number, int number_of_request=30, int cylinder_number=40){
    ...
    while(static_cast<int>(set.size()) != number_of_request){
        ...
        if(set.count(guess)==1)
            ...
            jobList.push_back(Request(name, guess, 0));
        }
    }
    return jobList;
}
...
void three_test_case_driver_for_table(){
    ...
    vector<Request> result1 = first_come_first_serverd(starting_point1, case1);
    cout<<"Head movement chart: "<<endl;
    for(auto i: result1){
        cout<<i.cylinderNumber<<"->";
    }
    ...
    for(size_t j=1; j<result1.size(); j++){
        Request i = result1[j];
        cout<<i.length<<"+";
        sum_cylinders1+=i.length;
    }
    cout<<"="<<sum_cylinders1<<endl;


    cout<<"Result of shortest_seek_first"<<endl;
    vector<Request> result2 = shortest_seek_first(starting_point1, case1);
    cout<<"Head movement chart: "<<endl;
    for(auto i: result2){
        cout<<i.cylinderNumber<<"->";
    }
    ...
    for(size_t j=1; j<result2.size(); j++){
        Request i = result2[j];
        cout<<i.length<<"+";
        sum_cylinders2+=i.length;
    }
    cout<<"="<<sum_cylinders2<<endl;
    cout<<"Result of M-U"<<endl;
    vector<Request> result3 =elevator_moving_upward(starting_point1, case1);
    cout<<"Head movement chart: "<<endl;
    for(auto i: result3){
        cout<<i.cylinderNumber<<"->";
    }
    ...
    for(size_t j=1; j<result3.size(); j++){
        Request i = result3[j];
        cout<<i.length<<"+";
        sum_cylinders3+=i.length;
    }
    cout<<"="<<sum_cylinders3<<endl;
    cout<<endl<<endl<<endl;
    cout<<"Result of FCFS"<<endl;
    vector<Request> result4 = first_come_first_serverd(starting_point2, case2);
    cout<<"Head movement chart: "<<endl;
    for(auto i: result4){
        cout<<i.cylinderNumber<<"->";
    }
    ...
    for(size_t j=1; j<result4.size(); j++){
        Request i = result4[j];
        cout<<i.length<<"+";
        sum_cylinders4+=i.length;
    }
    cout<<"="<<sum_cylinders4<<endl;
    cout<<"Result of shortest_seek_first"<<endl;
    vector<Request> result5 = shortest_seek_first(starting_point2, case2);
    ...
    cout<<endl;
    cout<<"Total cylinder move: "<<endl;
    for(size_t j=1; j<result5.size(); j++){
        Request i = result5[j];
        cout<<i.length<<"+";
        sum_cylinders5+=i.length;
    }
    cout<<"="<<sum_cylinders5<<endl;
    cout<<"Result of M-U"<<endl;
    vector<Request> result6 =elevator_moving_upward(starting_point2, case2);
    cout<<"Head movement chart: "<<endl;
    for(auto i: result6){
        cout<<i.cylinderNumber<<"->";
    }
    ...
    for(size_t j=1; j<result6.size(); j++){
        Request i = result6[j];
        cout<<i.length<<"+";
        sum_cylinders6+=i.length;
    }
    cout<<"="<<sum_cylinders6<<endl;
    cout<<endl<<endl<<endl;
    cout<<"Result of FCFS"<<endl;
    vector<Request> result7 = first_come_first_serverd(starting_point3, case3);
    cout<<"Head movement chart: "<<endl;
    for(auto i: result7){
        cout<<i.cylinderNumber<<"->";
    }
    ...
    for(size_t j=1; j<result7.size(); j++){
        Request i = result7[j];
        cout<<i.length<<"+";
        sum_cylinders7+=i.length;
    }
    cout<<"="<<sum_cylinders7<<endl;
    cout<<"Result of shortest_seek_first"<<endl;
    vector<Request> result8 = shortest_seek_first(starting_point3, case3);
    cout<<"Head movement chart: "<<endl;
    for(auto i: result8){
        cout<<i.cylinderNumber<<"->";
    }
    ...
    for(size_t j=1; j<result8.size(); j++){
        Request i = result8[j];
        cout<<i.length<<"+";
        sum_cylinders8+=i.length;
    }
    cout<<"="<<sum_cylinders8<<endl;
    cout<<"Result of M-U"<<endl;
    vector<Request> result9 =elevator_moving_upward(starting_point3, case3);
    cout<<"Head movement chart: "<<endl;
    for(auto i: result9){
        cout<<i.cylinderNumber<<"->";
    }
    ...
    for(size_t j=1; j<result9.size(); j++){
        Request i = result9[j];
        cout<<i.length<<"+";
        sum_cylinders9+=i.length;
    }
...
void case_trail_driver(int number_of_case, int trail=10){
    ...
    for(int i =0; i<trail; i++){
        vector<Request> temp = first_come_first_serverd(starting_point_vector[i], list_of_request[i]);
        int sum_cylinders = 0;
        for(auto i: temp){
            sum_cylinders+=i.length;
        }
    ...
    for(int i =0; i<trail; i++){
        vector<Request> temp = shortest_seek_first(starting_point_vector[i], list_of_request[i]);
        int sum_cylinders = 0;
        for(auto i: temp){
            sum_cylinders+=i.length;
        }
    ...
    for(int i =0; i<trail; i++){
        vector<Request> temp = elevator_moving_upward(starting_point_vector[i], list_of_request[i]);
        int sum_cylinders = 0;
        for(auto i: temp){
            sum_cylinders+=i.length;
        }
...
int main()
{
    srand (time(NULL));
    //genrateCase_driver();
    //driveTest_shortest_seek_first();
    //my_test();
    //driveTest_elevator_moving_upward();
    //part3_driver();
    //three_test_case_driver_for_table();
    driveTest_elevator_moving_upward();
